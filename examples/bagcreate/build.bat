...
echo Building bagcreate application
nmake -f Makefile_win32
goto end1

:build_clean
echo Cleaning bagcreate application
...
:build_rebuild
echo Rebuilding bagcreate application
call build clean
call build
goto end1

:build_world
echo Building the world for the bagcreate application
call build clean
call build project
call build
goto end1
