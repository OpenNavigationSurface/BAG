...
echo Building signcert application
nmake -f Makefile_win32
goto end1

:build_clean
echo Cleaning signcert application
...
:build_rebuild
echo Rebuilding signcert application
call build clean
call build
goto end1

:build_world
echo Building the world for the signcert application
call build clean
call build project
call build
goto end1
