...
echo Building verifyfile application
nmake -f Makefile_win32
goto end1

:build_clean
echo Cleaning verifyfile application
nmake -f Makefile_win32 clean
goto end1

:build_project
echo Building verifyfile application project
qmake -t app -o Makefile_win32 verifyfile.pro
qmake -t vcapp verifyfile.pro
goto end1

:build_rebuild
echo Rebuilding verifyfile application
call build clean
call build
goto end1

:build_world
echo Building the world for the verifyfile application
call build clean
call build project
call build
goto end1
