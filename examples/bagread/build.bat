...
echo Building bagread application
nmake -f Makefile_win32
goto end1

:build_clean
echo Cleaning bagread application
...
:build_rebuild
echo Rebuilding bagread application
call build clean
call build
goto end1

:build_world
echo Building the world for the bagread application
call build clean
call build project
call build
goto end1
