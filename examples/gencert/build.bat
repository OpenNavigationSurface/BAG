...
echo Building gencert application
nmake -f Makefile_win32
goto end1

:build_clean
echo Cleaning gencert application
...
:build_rebuild
echo Rebuilding gencert application
call build clean
call build
goto end1

:build_world
echo Building the world for the gencert application
call build clean
call build project
call build
goto end1
