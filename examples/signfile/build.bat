...
echo Building signfile application
nmake -f Makefile_win32
goto end1

:build_clean
echo Cleaning signfile application
...
:build_rebuild
echo Rebuilding signfile application
call build clean
call build
goto end1

:build_world
echo Building the world for the signfile application
call build clean
call build project
call build
goto end1
