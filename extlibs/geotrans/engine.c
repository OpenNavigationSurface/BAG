...
{ /* Initialize_Engine */
  ...
  strcpy(Coordinate_System_Table[Lambert_Conformal_Conic].Name, "Lambert Conformal Conic");
...
{ /* Get_Conversion_Status_String */
  ...
  if (!error_code)
  {
    ...
    case Lambert_Conformal_Conic:
      {
        sprintf(String,"%s%s%s%s",in_out," Lambert Conformal Conic Projection:",Separator,Separator);
        break;
      }
    case Local_Cartesian:
      {
    ...
    {
      strcat(String,"Standard Parallel out of range");
      strcat(String,Separator);
    }
