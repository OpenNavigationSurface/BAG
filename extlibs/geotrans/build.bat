...
echo Building the geotrans library
nmake -f Makefile_win32
goto end1

:build_clean
echo Cleaning the geotrans library
nmake -f Makefile_win32 clean
goto end1

:build_project
echo Building the geotrans library project
qmake -t lib -o Makefile_win32 geotrans.pro
qmake geotrans.pro
goto end1

:build_rebuild
echo Rebuilding the geotrans library
call build clean
call build
goto end1

:build_world
echo Building the world for the geotrans library
call build clean
call build project
call build
goto end1
