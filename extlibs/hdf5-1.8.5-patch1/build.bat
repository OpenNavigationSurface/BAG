...
:build_clean
echo Cleaning the hdf5 library
nmake -f Makefile_win32 clean
goto end1

:build_project
echo Building the hdf5 library project
qmake -t lib -o Makefile_win32 hdf5.pro
qmake -t vclib hdf5.pro
goto end1

:build_rebuild
echo Rebuilding the hdf5 library
call build clean
call build
goto end1

:build_world
echo Building the world for the hdf5 library
call build clean
call build project
call build
goto end1
