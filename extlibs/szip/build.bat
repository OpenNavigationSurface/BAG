...
:build_clean
echo Cleaning the szip library
nmake -f Makefile_win32 clean
goto end1

:build_project
echo Building the szip library project
qmake -t lib -o Makefile_win32 szip.pro
qmake szip.pro
goto end1

:build_rebuild
echo Rebuilding the szip library
call build clean
call build
goto end1

:build_world
echo Building the world for the szip library
call build clean
call build project
call build
goto end1
