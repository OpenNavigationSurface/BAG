...
/*
 * $Log: VCPPDefs.hpp,v $
 * Revision 1.2  2006/02/01 15:17:40  openns
 * Added project file for MS VC 7.x and updated build configuration to allow
 * for static library build instead of a DLL build.
 *
