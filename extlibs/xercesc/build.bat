...
echo Building the xerces library
nmake -f Makefile_win32
goto end1

:build_clean
echo Cleaning the xerces library
nmake -f Makefile_win32 clean
goto end1

:build_project
echo Building the xerces library project
qmake -t lib -o Makefile_win32 xerces.pro
qmake xerces.pro
goto end1

:build_rebuild
echo Rebuilding the xerces library
call build clean
call build
goto end1

:build_world
echo Building the world for the xerces library
call build clean
call build project
call build
goto end1
