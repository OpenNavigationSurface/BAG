/*** THIS HEADER is adapted from UNIX platform (autoconf routine)***, it is modified and manually
maintained by HDF group, many  UNIX comments are intentionally kept for maintenance purpose ***/
...
/* The number of bytes in a long long. we use __int64 instead, ignore this constant  */
/*#define SIZEOF_LONG_LONG 0*/

/* number of bytes in a __int64*/
#define HAVE___int64
...
/*use this flag to get around some of the problems with not having RUSAGE and time functions(see iopipe.c)*/
#define HAVE_SYS_TIMEB 
/* Define if you have the <sys/types.h> header file.  */
#define HAVE_SYS_TYPES_H 1
/* Define to `long' if system headers don't define the ssize_t type */ 
#define ssize_t long      
/*new macro that was added to the configure script*/ 
#define HAVE_STDDEF_H 
#define HAVE_WINSOCK_H  
/* Define if you have the setjmp.h header.  */ 
#define HAVE_SETJMP_H 1  
/*remove these 2 definitions if you don't want the zlib*/ 
#define HAVE_LIBZ 1 
