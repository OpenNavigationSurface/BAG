 ...
 *
 * Description : 
 *               This is the main module for open/close/create of 
 *               a BAG file.
 *
...
#define	META_DATA_BLOCK_SIZE           1024           /* The block size defines the allocation/allocation extension unit size */
...
bagError bagGetErrorString(bagError code, char **error)
{
    ...
    *error = str;
    ...
    case BAG_BAD_FILE_IO_OPERATION:
        strncpy (str, "File IO operation", MAX_STR-1);
        break;
    ...
    case BAG_INVALID_BAG_HANDLE:
        strncpy (str, "Invalid bagHandle", MAX_STR-1);
        break;
