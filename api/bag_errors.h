...
#define BAG_GEOREF_METADATA_LAYER_ERROR_BASE   1000
...
enum BAG_ERRORS {
    ...
    BAG_INVALID_LAYER_TYPE                     =  11, //!< Layer type larger than UNKNOWN_LAYER_TYPE encountered
    ...
    BAG_MORE_BAG_INSTANCES_PRESENT             =  30, //!< There are still instances of the BAG in memory
    ...
    BAG_GEOREF_METADATA_LAYER_MISSING                    = BAG_GEOREF_METADATA_LAYER_ERROR_BASE,      //!< Georef: The specified layer does not exist
    BAG_GEOREF_METADATA_LAYER_RECORD_NOT_FOUND           = BAG_GEOREF_METADATA_LAYER_ERROR_BASE + 1,  //!< Georef: Unable to find record
    BAG_GEOREF_METADATA_LAYER_FIELD_NOT_FOUND            = BAG_GEOREF_METADATA_LAYER_ERROR_BASE + 2,  //!< Georef: Unable to find field
    BAG_GEOREF_METADATA_LAYER_NO_VALUE_FOUND             = BAG_GEOREF_METADATA_LAYER_ERROR_BASE + 3,  //!< Georef: Unable to find the value
    BAG_GEOREF_METADATA_LAYER_INVALID_RECORD_DEFINITION  = BAG_GEOREF_METADATA_LAYER_ERROR_BASE + 4,  //!< Georef: The provided record does not match the definition in the georeferenced metadata layer
    BAG_GEOREF_METADATA_LAYER_NAME_MISSING               = BAG_GEOREF_METADATA_LAYER_ERROR_BASE + 5,  //!< Georef: A georeferenced metadata layer name is required
    BAG_GEOREF_METADATA_LAYER_EXISTS                     = BAG_GEOREF_METADATA_LAYER_ERROR_BASE + 6,  //!< Georef: The specified layer already exists
    BAG_GEOREF_METADATA_LAYER_PROFILE_UNKNOWN            = BAG_GEOREF_METADATA_LAYER_ERROR_BASE + 7,  //!< Georef: The specified metadata profile is unknown
    BAG_GEOREG_METADATA_LAYER_PROFILE_UNKNOWN            = BAG_GEOREF_METADATA_LAYER_ERROR_BASE + 7,  //!< Alias for BAG_GEOREF_METADATA_LAYER_PROFILE_UNKNOWN
