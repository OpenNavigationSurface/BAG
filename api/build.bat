...
echo Building the bag library
nmake -f Makefile_win32
goto end1

:build_clean
echo Cleaning the bag library
nmake -f Makefile_win32 clean
goto end1

:build_project
echo Building the bag library project
qmake -t lib -o Makefile_win32 bag.pro
qmake bag.pro
goto end1

:build_rebuild
echo Rebuilding the bag library
call build clean
call build
goto end1

:build_world
echo Building the world for the bag library
call build clean
call build project
call build
goto end1
